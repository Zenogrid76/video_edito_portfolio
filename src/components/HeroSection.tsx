...
export const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden">
      ...
      <div className="hidden sm:block absolute top-1/4 left-4 sm:left-10 w-2 h-2 bg-primary rounded-full animate-float opacity-60" />
      <div
        className="hidden sm:block absolute top-1/3 right-4 sm:right-20 w-3 h-3 bg-primary/50 rounded-full animate-float"
        style={{ animationDelay: ".5s" }}
      />
      <div
        className="hidden sm:block absolute bottom-1/3 left-4 sm:left-1/4 w-1.5 h-1.5 bg-primary rounded-full animate-float"
        style={{ animationDelay: "1s" }}
      />

      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Mobile-only top padding: ~50px navbar + 20-30px breathing room */}
        <div className="pt-40 sm:pt-40">
          <div className="max-w-4xl mx-auto text-center">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-effect mb-6 sm:mb-8 text-sm">
            ...
            {/* Main Heading */}
            <h1 className="font-display text-3xl xs:text-5xl sm:text-5xl md:text-8xl lg:text-8xl leading-tight mb-4 md:mb-6 animate-slide-up">
        ...
        {/* Scroll indicator - moved up on mobile to avoid bottom UI bars */}
